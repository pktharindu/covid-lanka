        ...
        >
          ...
          >
            ...
            <span
              ...
              data-balloon-pos="up"
              class="mt-6 lg:mt-0 lg:-translate-y-4 font-bold text-xl text-center text-blue-600 transform"
            >
              <animated-number
                :value="newCases"
          ...
          >
            ...
            <span
              ...
              data-balloon-length="medium"
              data-balloon-pos="up"
              class="mt-6 lg:mt-0 lg:-translate-y-4 font-bold text-xl text-center text-purple-600 transform"
            >
              <animated-number
                :value="totalCases"
                :formatValue="numberFormat"
          ...
          >
            ...
            <span
              ...
              data-balloon-length="medium"
              data-balloon-pos="up"
              class="mt-6 lg:mt-0 lg:-translate-y-4 font-bold text-xl text-center text-teal-600 transform"
            >
              <animated-number
                :value="hospitalized"
                :formatValue="numberFormat"
          ...
          >
            ...
            <span
              ...
              data-balloon-length="medium"
              data-balloon-pos="up"
              class="mt-6 lg:mt-0 lg:-translate-y-4 font-bold text-xl text-center text-yellow-600 transform"
            >
              <animated-number
                :value="newDeaths"
                :formatValue="numberFormat"
          ...
          >
            ...
            <span
              ...
              data-balloon-length="medium"
              data-balloon-pos="up"
              class="mt-6 lg:mt-0 lg:-translate-y-4 font-bold text-xl text-center text-red-600 transform"
            >
              <animated-number
                :value="totalDeaths"
                :formatValue="numberFormat"
          ...
          >
            ...
            <span
              ...
              data-balloon-length="medium"
              data-balloon-pos="up"
              class="mt-6 lg:mt-0 lg:-translate-y-4 font-bold text-xl text-center text-orange-600 transform"
            >
              <animated-number
                :value="fatalityRate"
          ...
          >
            ...
            <span
              ...
              data-balloon-length="medium"
              data-balloon-pos="up"
              class="mt-6 lg:mt-0 lg:-translate-y-4 font-bold text-xl text-center text-green-600 transform"
            >
              <animated-number
                :value="recovered"
                :formatValue="numberFormat"
